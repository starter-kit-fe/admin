...
import { IUser } from '@/app/auth/_type';
import { postSignup, postCode } from '@/app/auth/_api';
import { AuthStep, useAuthStore } from '@/app/auth/_store';
...
const usePasswordForm = () => {
  ...
  const { authParams, setParams, setStep, removeParams, setToken } =
    useAuthStore();
  ...
  const signinMutation = useMutation({
    mutationFn: (data: IUser.signupParams) => postSignup(data),
    onSuccess: (data) => {
      setToken(data);
